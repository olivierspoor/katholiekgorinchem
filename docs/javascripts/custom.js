...
document.addEventListener('DOMContentLoaded', function() {
    function updateNextMass() {
        ...
        const specialMasses = {
            ...
            '2026-04-03': { text: "Eerstvolgende viering: <span class='mobile-break'></span>Kruisweg om 15:00", hour: 16 },
            '2026-04-03': { text: "Eerstvolgende viering: <span class='mobile-break'></span>Kruisverering om 19:00", hour: 20 },
            '2026-02-04': { text: "Eerstvolgende mis: Paaswake:<span class='mobile-break'></span>Eucharistieviering om 21:00", hour: 22 },
